    ...
    public function run()
    {
        $query = "INSERT INTO users (role_id, email, email_verified_at, password, remember_token, created_at, updated_at)
                  VALUES (1, 'admin@studium.com', 'now()', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', ?, 'now()', 'now()'),
                         (2, 'director@studium.com', 'now()', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', ?, 'now()', 'now()'),
                         (3, 'profesor@studium.com', 'now()', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', ?, 'now()', 'now()'),
                         (4, 'estudiante@studium.com', 'now()', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', ?, 'now()', 'now()')";
