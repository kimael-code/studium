<template>
  ...
  <div class="card">
    <header class="card-header">
      <p class="card-header-title">Tarjeta uno</p>
      <button class="card-header-icon" aria-label="ícono">
        <span class="icon">
  ...
  <div class="card">
    <header class="card-header">
      <p class="card-header-title">Tarjeta dos</p>
      <button class="card-header-icon" aria-label="ícono">
        <span class="icon">
  ...
  <div class="card">
    <header class="card-header">
      <p class="card-header-title">Tarjeta tres</p>
      <button class="card-header-icon" aria-label="ícono">
        <span class="icon">
